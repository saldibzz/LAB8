...
namespace MusicApp2017.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [Authorize]
        public async Task<ActionResult> EditProfile(string FavoriteGenre)
        {
            var currentUser = await _userManager.GetUserAsync(User);
            currentUser.FavoriteGenre = FavoriteGenre;
            var succeeded = await _userManager.UpdateAsync(currentUser);
            ViewData["successmessage"] = "Favorite Genre has been updated";
            return View();
        }
